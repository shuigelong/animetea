...
<div class="about">
        <h1 id="title">MYC全职only——叶修生日会</h1>
    </div>
<div class="about">
<h3>USER：lanlan<br>Time：2017-5<br> Address：北京市 北京市 西城区 北京西站光耀东方广场 </h3>
</div>   
  
<div class="about">
<h3>Detial：</h3>
<h3>时间：2017.5.29 9:00-16:00</h3>
<img  src="img/0.jpg">
</div> 
<div class="about">
<form id="upcommit" action="./infornation"  method="post" >
<input type="hidden" value="MYC全职only——叶修生日会" name="title"></input>
