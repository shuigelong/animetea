...
<div class="about">
        <h1 id="title">GARNiDELiA stellacage TOUR 2017 ~Cry Out~ in </h1>
    </div>
<div class="about">
<h3>USER：lanlan<br>Time：2017-5<br> Address：上海市 上海市 普陀区 万代南梦宫上海文化中心 梦想剧场 </h3>
</div>   
  
<div class="about">
<h3>Detial：</h3>
<h3>时间：2017年5月20日（周六）</h3>
<img  src="img/03.jpg">
</div> 
<div class="about">
<form id="upcommit" action="./infornation"  method="post" >
<input type="hidden" value="GARNiDELiA stellacage TOUR 2017 ~Cry Out~ in " name="title"></input>
