...
<div class="about">
        <h1 id="title">南京GJ lily夏日祭</h1>
    </div>
<div class="about">
<h3>USER：lanlan<br>Time：2017-7<br> Address：江苏省 南京市 玄武区 南京新庄国际会展中心 </h3>
</div>   
  
<div class="about">
<h3>Detial：</h3>
<h3>时间：2017.7.16地点：南京新庄国际会展中心</h3>
<img  src="img/00.jpg">
</div> 
<div class="about">
<form id="upcommit" action="./infornation"  method="post" >
<input type="hidden" value="南京GJ lily夏日祭" name="title"></input>
